    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('self_invite', models.CharField(blank=True, max_length=6, null=True, verbose_name='инвайт код')),
                ...
                ('received_invite', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL, verbose_name='полученный инвайт код')),
